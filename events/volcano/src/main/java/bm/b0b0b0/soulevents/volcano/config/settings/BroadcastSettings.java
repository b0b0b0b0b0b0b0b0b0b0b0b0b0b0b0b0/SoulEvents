...
public class BroadcastSettings extends YamlSerializable {
    ...
    public String messageKey = "volcano.broadcast.default";
    ...
    public String unlockedMessageKey = "volcano.broadcast.unlocked";
    ...
    public String openedMessageKey = "volcano.broadcast.opened";
    ...
    public String lootedMessageKey = "volcano.broadcast.looted";
    ...
    public String removedMessageKey = "volcano.broadcast.removed";
}
