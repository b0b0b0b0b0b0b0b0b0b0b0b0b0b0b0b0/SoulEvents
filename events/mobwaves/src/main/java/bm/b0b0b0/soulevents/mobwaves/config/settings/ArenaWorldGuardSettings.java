...
public final class ArenaWorldGuardSettings extends YamlSerializable {
    ...
    @Comment(@CommentValue("Приоритет региона (выше = сильнее перекрывает spawn/__global__ и mob-damage: deny)."))
    public int regionPriority = 10000;
    ...
    @Comment(@CommentValue("Горизонтальный радиус (блоки) от нексуса, если схематики нет."))
    public int marginWithoutSchematic = 96;
