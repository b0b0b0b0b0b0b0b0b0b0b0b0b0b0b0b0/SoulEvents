...
import bm.b0b0b0.soulevents.volcano.config.settings.ObfuscationItemsGuiSettings;
...
public final class VolcanoObfuscationItemsMenu implements InventoryHolder {
    ...
    public VolcanoObfuscationItemsMenu(
