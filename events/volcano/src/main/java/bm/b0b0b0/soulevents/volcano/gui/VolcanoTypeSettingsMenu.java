...
import bm.b0b0b0.soulevents.volcano.config.settings.TypeSettingsGuiSettings;
...
public final class VolcanoTypeSettingsMenu implements InventoryHolder {
    ...
    public VolcanoTypeSettingsMenu(
